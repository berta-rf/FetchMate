...
class TestMatchedBreeds(TestCase):
    ...
    def test_perfect_matches(self, mock_download_dog_image):
        ...
        mock_download_dog_image.return_value.status_code = (
            200  # returns a successful HTTP response
        )
        mock_download_dog_image.return_value = [
            dict(name="Affenpinscher"),
            dict(name="Appenzeller Sennenhund"),
        ]
    ...
    def test_perfect_matches_edge_case1(self, mock_download_dog_image):
        ...
        mock_download_dog_image.return_value = [
            dict(name="Afghan Hound"),
            dict(name="Bergamasco Sheepdog"),
        ]
    ...
    def test_perfect_matches_edge_case2(self, mock_download_dog_image):
        ...
        mock_download_dog_image.return_value.status_code = 200
        mock_download_dog_image.return_value = [
            dict(name="Barbado da Terceira"),
            dict(name="Doberman Pinscher"),
        ]
    ...
    def test_no_matches(self):
        ...
        result = get_matched_breeds(quiz_input, n=2)
        expected = {"You're a Cat Person🐱": "static/img/cat-white-wall.jpg"}
        self.assertEqual(result, expected)
